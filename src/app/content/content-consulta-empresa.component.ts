...
@Component({
    ...
    templateUrl: 'content-consulta-empresa.component.html',
    styleUrls: ['content-consulta-empresa.component.css']
})
...
export class ConsultaEmpresaComponent implements OnInit {
    ...
    openDialog(): void {
        let dialogRef = this.dialog.open(CadastroEmpresaComponent, {
          height : '600px',
          width: '400px',
          data: {
               name: this.name, 
